...
const uiSeries = {
  ...
  portfolio_2: {
    ...
    perfBridge:[
      ...
      {label:"+ Net Capital Added",val:86805,color:"#2563eb",kind:"line"},
      {label:"+ FY26 MTM + Dist.",val:92891,color:"#16a34a",kind:"line"},
      {label:"+ Dividends Received",val:47971,color:"#0d9488",kind:"line"},
      {label:"+ Realised P&L",val:16615,color:"#ea580c",kind:"line"},
      {label:"= Current Portfolio",val:1138099,color:"#1d4ed8",kind:"grand"},
    ],
